...
function zotspip_rechercher_liste_des_champs($tables) {
    ...
    $tables['zcollection']['zcollection'] = 10;

    //$tables['zcreator']['auteur'] = 10;
    $tables['zcreator']['id_zitem'] = 5;
    $tables['zcreator']['role'] = 3;

    //$tables['zitems_zcollection']['id_zcollection'] = 10;
    $tables['zitems_zcollection']['id_zitem'] = 10;

    //$tables['ztag']['tag'] = 10;
    $tables['ztag']['id_zitem'] = 5;
